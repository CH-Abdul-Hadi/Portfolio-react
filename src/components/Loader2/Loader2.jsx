...
const StyledWrapper = styled.div`
  ...
  .loader__balls__group :nth-child(1) {
    background-image: linear-gradient(
      267deg,
      rgba(218, 125, 37, 0.29) 0.36%,
      rgba(184, 35, 225, 0.26) 102.06%
    );
  ...
  .loader__balls__group :nth-child(2) {
    background-image: linear-gradient(
      267deg,
      rgba(218, 125, 37, 0.62) 0.36%,
      rgba(184, 35, 225, 0.55) 102.06%
    );
  ...
  .loader__balls__group :nth-child(3) {
    background-image: linear-gradient(267deg, #da7c25 0.36%, #b923e1 102.06%);
